...
function createNotif(notifData) {
    ...
    let profilePicSrc = notifData.source.profilePic ? `/uploads/${notifData.source.profilePic}` : "/images/Profile-PNG-File.png"
    ...
    notifList.innerHTML += `<li><hr class="dropdown-divider my-0"></li>`
